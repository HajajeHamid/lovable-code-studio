...
export default {
  darkMode: ["class"],
  content: ["./pages/*.{ts,tsx}", "./components/*.{ts,tsx}", "./api/*.{ts,tsx}", "./store/*.{ts,tsx}"],
  prefix: "",
  theme: {
    container: {
      center: true,
    ...
    extend: {
      ...
      colors: {
        ...
        block: {
          enum: "hsl(var(--block-enum))",
          model: "hsl(var(--block-model))",
          component: "hsl(var(--block-component))",
          api: "hsl(var(--block-api))",
          directive: "hsl(var(--block-directive))",
          module: "hsl(var(--block-module))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
